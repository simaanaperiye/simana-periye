  ...
  return (
    <>
      <nav style={{
        ...
        <Link href="/" style={{ fontFamily: "var(--font-cormorant)", fontSize: "1.7rem", fontWeight: 600, letterSpacing: "0.04em", color: onHero ? "white" : "#0f172a", textDecoration: "none", transition: "color 0.4s" }}>
