...
async function main() {
  ...
  const plans = [
    ...
    },
    {
      ...
      longDesc: "Discover the magic of Bangkok with our curated city tour. Visit the majestic Grand Palace and Wat Phra Kaew, cruise the Chao Phraya river to see Wat Arun at golden hour, explore the famous floating markets, shop at Chatuchak Weekend Market, and indulge in authentic Thai street food throughout.",
      price: 48000,
      duration: 6,
      maxPeople: 15,
