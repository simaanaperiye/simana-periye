...
async function main() {
  ...
  const plans = [
    ...
    },
    {
      ...
      region: "India",
      description: "Tawang's golden monastery, Sela Pass at 13,700 ft, Madhuri Lake, and Bumla Pass — India's last frontier beckons.",
      longDesc: "Journey from Guwahati into the mystical northeast — tea gardens, Tipi Orchidarium, hot springs, the legendary Sela Pass, Jaswant Garh War Memorial, Tawang Monastery (largest in India), Bumla Pass (complimentary, subject to army clearance), Madhuri Lake, and Bomdila on the return. Tempo traveller throughout, all meals, Inner Line Permits included.",
      price: 22000,
      duration: 7,
      maxPeople: 20,
